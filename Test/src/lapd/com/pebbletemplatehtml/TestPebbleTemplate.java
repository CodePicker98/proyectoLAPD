...
public class TestPebbleTemplate {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PebbleTemplate compiledTemplate = engine.getTemplate("templates\\TemplateHTML.html");
			...
			BufferedWriter bw = new BufferedWriter(new FileWriter("outputs\\HTML1.html"));
			bw.write(output);
			bw.close();
